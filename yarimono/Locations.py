...
TRAINER_FIGHTS: list[LocationDef] = [
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 2, "Defeat Hikari",
                LocCategory.TRAINER_FIGHT, region="Hajime Village"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 34, "Defeat Sanae",
                LocCategory.TRAINER_FIGHT, region="Hajime Village"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 63, "Defeat Luna",
                LocCategory.TRAINER_FIGHT, required_level=54, region="Laboratory",
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 3, "Defeat Kantaro",
                LocCategory.TRAINER_FIGHT, region="Hajime Road"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 56, "Defeat Smith",
                LocCategory.TRAINER_FIGHT, region="Old Road"),

    # Big City
    LocationDef(TRAINER_FIGHT_BASE_ID + 12, "Defeat Leo",
                LocCategory.TRAINER_FIGHT, region="Big City Entrance"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 47, "Defeat Natsumi",
                LocCategory.TRAINER_FIGHT, region="Big City"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 67, "Defeat Melon",
                LocCategory.TRAINER_FIGHT, region="Laboratory (Big City)"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 27, "Defeat Riona",
                LocCategory.TRAINER_FIGHT, region="Typeless Gym"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 20, "Defeat Corn",
                LocCategory.TRAINER_FIGHT, region="Ryugasaki Gym"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 14, "Defeat Yamato",
                LocCategory.TRAINER_FIGHT, region="Beach Road"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 65, "Defeat Haruka",
                LocCategory.TRAINER_FIGHT, region="Tea House"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 16, "Defeat Nene",
                LocCategory.TRAINER_FIGHT, region="Holy Road"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 18, "Defeat Armin",
                LocCategory.TRAINER_FIGHT, region="Central Church"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 50, "Defeat Marisa",
                LocCategory.TRAINER_FIGHT, region="Central Church 2F"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 112, "Defeat Rumi",
                LocCategory.TRAINER_FIGHT, region="Harbor Town", rule=CanReachRegion("Dojo")),

    # Harbor Town
    LocationDef(TRAINER_FIGHT_BASE_ID + 58, "Defeat Akari",
                LocCategory.TRAINER_FIGHT, region="Harbor Town"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 60, "Defeat Mei",
                LocCategory.TRAINER_FIGHT, region="Harbor Gym"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 74, "Defeat Minako",
                LocCategory.TRAINER_FIGHT, region="Pool"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 51, "Defeat Shishio",
                LocCategory.TRAINER_FIGHT, region="Wano Village"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 54, "Defeat Phineh",
                LocCategory.TRAINER_FIGHT, region="Wano Village School"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 105, "Defeat Nanase",
                LocCategory.TRAINER_FIGHT, region="Dojo"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 126, "Defeat Marble",
                LocCategory.TRAINER_FIGHT, region="Yarimon Center (Wano Village)"),

    # Shrine
    LocationDef(TRAINER_FIGHT_BASE_ID + 55, "Defeat Umenoki",
                LocCategory.TRAINER_FIGHT, region="Shrine"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 125, "Defeat Charlie",
                LocCategory.TRAINER_FIGHT, region="Old Road North"),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 140, "Defeat Hotaru (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Hajime Road", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 142, "Defeat Sanae (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Hajime Village", rule=CanReachLocation("Defeat Athena")),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 147, "Defeat Honoka (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Big City", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 151, "Defeat Melon (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Laboratory (Big City)", rule=CanReachLocation("Defeat Athena")),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 157, "Defeat Murasaki (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Beach Road", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 163, "Defeat Nene (DLC2)",
                LocCategory.TRAINER_FIGHT, region="Resort", rule=CanReachLocation("Defeat Tama")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 165, "Defeat Marisa (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Central Church", rule=CanReachLocation("Defeat Athena")),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 174, "Defeat Minako (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Pool", rule=CanReachLocation("Defeat Athena")),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 183, "Defeat Kanako (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Cave Road", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 193, "Defeat Nanase (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Dojo", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 200, "Defeat Murei (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Shrine", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 201, "Defeat Aya (DLC2)",
                LocCategory.TRAINER_FIGHT, region="Lake", rule=CanReachLocation("Defeat Tama")),
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 205, "Defeat Leo (DLC1)",
                LocCategory.TRAINER_FIGHT, region="Forest of Trials",
    ...
    LocationDef(TRAINER_FIGHT_BASE_ID + 212, "Defeat Meena (DLC2)",
                LocCategory.TRAINER_FIGHT, region="Makina Ranch", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 213, "Defeat Shishio (DLC2)",
                LocCategory.TRAINER_FIGHT, region="Wano Village", rule=CanReachLocation("Defeat Athena")),
    LocationDef(TRAINER_FIGHT_BASE_ID + 214, "Defeat Anna (DLC2)",
                LocCategory.TRAINER_FIGHT, region="Resort"),
    LocationDef(TRAINER_FIGHT_BASE_ID + 221, "Defeat Nupuryu",
                LocCategory.TRAINER_FIGHT, required_level=145, region="Monthly 3F"),
]
